...
public class MainVelha extends AppCompatActivity {
    ...
    private Button btnVoltarJVelha;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVoltarJVelha = findViewById(R.id.btnVoltarJVelha);
        ...
        btnVoltarQuebra.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void Voltar(){
        Intent janelavolt = new Intent(this, MainActivity.class);
        startActivity(janelavolt);
    }
    }
}
